...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('car_assembly'),
        'worlds',
        'empty_world.world'
    )
    ...
    pkg_gazebo = get_package_share_directory('car_assembly')
    ...
    rviz_config_dir = PathJoinSubstitution(
        [FindPackageShare("car_assembly"), "rviz", "model_and_laser_display.rviz"]
    )
